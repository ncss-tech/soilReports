...
output: 
  html_document: 
    ...
    toc_float:
      ...
      smooth_scroll: no
params:
   projectname: !r as.character("MLRA 104 - Readlyn soils texture and slope phases")
   geodatabase:  !r as.character("RTSD_MLRA_11-WAV_FY18.gdb")
   project_data: !r as.character("M:/geodata/project_data/")
   mlrassoarea:  !r as.character("11-WAV")
---
# Report Description
