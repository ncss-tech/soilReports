...
output: 
  html_document: 
    ...
    toc_float:
      ...
      smooth_scroll: no
params:
  projectname: !r as.character("EVAL - MLRA 111D - Crosby-Fincastle silt loams, 2 to 6 percent slopes;EVAL - MLRA 111D - Fincastle silt loam, Southern Ohio Till Plain, 2 to 4 percent slopes;EVAL - MLRA 111D - Fincastle silt loam, Tipton Till Plain, 2 to 4 percent slopes")
---
...
f    <- fetchWebReports(projectname, fill = TRUE, stringsAsFactors = TRUE)
pm   <- f$mapunit
comp <- f$spc
...
cosm <- get_cosoilmoist_from_NASISWebReports(projectname, stringsAsFactors = TRUE)
