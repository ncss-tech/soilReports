...
output: 
  html_document: 
    ...
    toc_float:
      ...
      smooth_scroll: no
params:
  projectname: !r as.character("EVAL - MLRA 114A - Hickory silt loam, Illinoian Till Plain, 12 to 18 percent slopes, eroded;EVAL - MLRA 114A - Hickory silt loam, Muscatatuck Plateau, 12 to 18 percent slopes, eroded")
---
...
kable(pm[idx, c("mlrassoarea", "projecttypename", "fiscalyear", "projectname")])
...
h_profiles <- 8 # ceiling(n_coiid / 10) * 4
...
for (i in seq_along(unique(profile_idx))) {
  plot(comp[which(profile_idx == i)], name = 'hzname', label = 'comp_id', color = 'color', id.style = "top")
  }
