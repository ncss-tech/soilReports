...
h3 <- merge(vars_slice, site(comp)[c("dmuiid2", "comp_id", "coiid", "compname2", "comppct_r", "localphase", "taxpartsize")], by = "comp_id", all.x = TRUE)
...
gg_list <- lapply(vars, function(x) {
  h_sub = h5[c("dmuiid2", "comp_id", "coiid", "compname2", "comppct_r", "localphase", "taxpartsize", "hzname", "dep", "hzdept_r", "hzdepb_r", "hzdep_m",
  ...
  if (x == "ksat") {
    ...
    gg_temp = gg_temp + scale_y_log10(breaks = brks, sec.axis = dup_axis()) + 
