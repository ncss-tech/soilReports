...
cosm <- get_cosoilmoist_from_LIMS(projectname)
...
```{r horizon data, , fig.dim = c(8, 8), fig.ext = "png", dev = "png_dplots"}
# profile plot

comp2 <- subsetProfiles(comp, h = "!is.na(hzdept_r)")
profile_idx <- pIndex(comp2, 10)
...
h3 <- merge(vars_slice, site(comp)[c("dmuiid2", "comp_id", "coiid", "compname2", "comppct_r", "localphase")], by = "comp_id", all.x = TRUE)
