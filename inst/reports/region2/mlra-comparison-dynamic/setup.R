...
.report.name <- 'mlra-comparison-dynamic'
.report.version <- '0.1'
.report.description <- 'compare MLRA/LRU-scale delineations, based on mu-comparison report'
...
.packages.to.get <- c('knitr', 'rmarkdown', 'rgdal', 'reshape2', 'raster', 'plyr', 'randomForest', 'Hmisc', 'aqp', 'soilDB', 'sharpshootR', 'latticeExtra', 'clhs', 'devtools', 'rgeos', 'vegan', 'spdep', 'scales', 'e1071')
