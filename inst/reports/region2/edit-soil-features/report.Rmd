...
```{r elevTable}
plot(density(f2$elev_r, na.rm = TRUE, from = pmin(0, min(f2$elev_l)), to = pmax(100, max(f2$elev_h)+100), kernel = "rectangular"), main = "Elevation (m)")
lines(density(f2$elev_l, na.rm = TRUE, from = pmin(0, min(f2$elev_l)), to = pmax(100, max(f2$elev_h)+100), kernel = "rectangular"), lty = 2, col = "red")
lines(density(f2$elev_h, na.rm = TRUE, from = pmin(0, min(f2$elev_l)), to = pmax(100, max(f2$elev_h)+100), kernel = "rectangular"), lty = 3, col = "blue")
