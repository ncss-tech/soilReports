...
res <- lapply(s, kdeContours, id='mlra', prob=c(0.75), cols=cols, m=levels(d.sub$mlra), lwd=1, lty=3)
res <- lapply(s, kdeContours, id='mlra', prob=c(0.5), cols=cols, m=levels(d.sub$mlra), lwd=1, lty=2)
res <- lapply(s, kdeContours, id='mlra', prob=c(0.25), cols=cols, m=levels(d.sub$mlra), lwd=2, lty=1)
