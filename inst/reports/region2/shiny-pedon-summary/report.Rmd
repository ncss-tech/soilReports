...
knitr::opts_chunk$set(echo = F, message=FALSE, warning = FALSE, fig.align='center', out.width="100%", fig.retina=2, dev='png', antialias='cleartype')
```
...
kable(site.i[order(site.i$musym, site.i$pedon_id), c('musym', 'pedon_id', 'taxonname', 'taxonkind', 'pedontype', 'bedrckdepth', 'taxpartsize', 'taxsubgrp', 'missing.genhz')])
```
