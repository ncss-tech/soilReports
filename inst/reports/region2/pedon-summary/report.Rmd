...
# data(loafercreek)
# f <- loafercreek
# f$longstddecimaldegrees <- f$x_std
# f$latstddecimaldegrees <- f$y_std
...
f.diagnostic <- join(site(f)[, c('pedon_id', 'peiid', 'musym', 'taxonname')], 
...
site(f) <- s$mgz
site.i <- site(f)
this.data <- site.i[order(site.i$musym, site.i$pedon_id), c(
  'musym',
  'pedon_id',
  'taxonname',
  'taxonkind',
