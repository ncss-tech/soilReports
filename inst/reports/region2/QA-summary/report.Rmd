...
SoilTaxonomyDendrogram(spc, cex.taxon.labels=0.8, width=0.25)
```
...
groupedProfilePlot(x, groups = 'groupname', label='dmudesc_short', group.name.cex = 0.75, group.name.offset = gno, color='ecec_r', col.label='ECEC (cmol[+] / kg)', col.legend.cex=0.85)
