...
n.groups <- length(unique(x$nationalmusym))
if(n.groups > 1) {
...
par(mar=c(1,1,4,1))
groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='claytotal_r', col.label='Clay Content (%)', col.legend.cex=0.85)

groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='sandtotal_r', col.label='Sand Content (%)', col.legend.cex=0.85)

groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='fragvoltot_r', col.label='Total Fragment Volumne (%)', col.legend.cex=0.85)

groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='texture', col.label='Texture', col.legend.cex=0.75)



groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='lep_r', col.label='LEP', col.legend.cex=0.85)

groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='cec7_r', col.label='CEC @ pH 7 (cmol[+] / kg)', col.legend.cex=0.85)

groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='sumbases_r', col.label='Sum of Bases (cmol[+] / kg)', col.legend.cex=0.85)

groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='base.sat', col.label='Base Saturation @ pH 7 (%)', col.legend.cex=0.85)



groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='ph1to1h2o_r', col.label='pH 1:1 H2O', col.legend.cex=0.85)

groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='ec_r', col.label='EC (mmhos/cm)', col.legend.cex=0.85)

groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='sar_r', col.label='SAR (%)', col.legend.cex=0.85)

groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='caco3_r', col.label='CaCO3 (%)', col.legend.cex=0.85)


groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='awc_r', col.label='AWC (cm / cm)', col.legend.cex=0.85)

groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='ksat_r', col.label='Ksat (um/s)', col.legend.cex=0.85)


groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='om_r', col.label='Organic Matter (%)', col.legend.cex=0.85)

groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = gno, color='dbthirdbar_r', col.label='Db 1/3 Bar (g / cc)', col.legend.cex=0.85)
