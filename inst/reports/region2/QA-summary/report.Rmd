...
groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = c(-16, -18), color='sumbases_r', col.label='Sum of Bases (cmol[+] / kg)', col.legend.cex=0.85)

groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = c(-16, -18), color='base.sat', col.label='Base Saturation @ pH 7 (%)', col.legend.cex=0.85)
...
groupedProfilePlot(x, groups = 'nationalmusym', label='dmuname', group.name.cex = 0.85, group.name.offset = c(-16, -18), color='caco3_r', col.label='CaCO3 (%)', col.legend.cex=0.85)
