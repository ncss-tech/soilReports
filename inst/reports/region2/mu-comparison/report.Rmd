...
kable(x.sig, caption = 'Top 75% fraction of landform classes, decreasing order.')
...
## TODO: compute distance from MU centroid by polygon, save to attr table

## TODO: add this to polygon output
...
# cast to wide format
d.mu.wide <- dcast(sampling.res$raster.samples, sid + .id ~ variable, value.var = 'value')
...
plot(Hmisc::varclus(as.matrix(d.sub[, -c(1:2)])))
```
