...
xyplot(y ~ x | variable, 
       groups = mu.col, data = density.plot.data, xlab = '', 
...
mu.stats.wide <- data.table::dcast(data.table::data.table(mu.stats), 
...
l <- lapply(d.cat.list, FUN = makeCategoricalOutput, mu.col = mu.col)
```
