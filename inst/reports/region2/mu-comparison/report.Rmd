...
### Flagged Polygons
These polygons, identified by `pID` in the output data, are associated with 15% or more samples that are outside of the 5th-95th percentile range.
```{r, echo=FALSE}
...
mu[['toCheck']] <- 0
flagged.pIDs <- unique(polygons.to.check$pID)
mu$toCheck[which(mu$pID %in% flagged.pIDs)] <- 1
